...
<!-- Une seule barre en bas (structure LayoutDesktop SDK, style neon via NeonUI snippets) -->
...
{#if stateUi.menuOpen}
	...
	/>
	<MainContainer standard alignVertical="bottom">
		<Container x={298} y={context.stateLayoutDerived.mainLayoutStandard().height - DESKTOP_BASE_SIZE - 10}>
