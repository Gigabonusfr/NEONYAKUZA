...
// Position plus haute : laisse la place à l'UI en bas, ne passe pas sous les boutons
const BOARD_Y_RATIO = 0.42;

const boardLayout = () => ({
	x: stateLayoutDerived.mainLayout().width * 0.5,
	y: stateLayoutDerived.mainLayout().height * BOARD_Y_RATIO,
	anchor: { x: 0.5, y: 0.5 },
